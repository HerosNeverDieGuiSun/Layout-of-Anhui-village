...
def get_house_categories_frequency(filename_label):
    ...
    dest_dir = f"../block_categories"
    # 设置文件路径
    CSV_FILE_PATH = '../block_categories/' + filename_label + '_cnts_block_categories.csv'
    # 定义存储数据结构
    data = []
    # 数据读取
    with open(CSV_FILE_PATH, 'r') as f:
...
def get_house_area_proportion(filename_label):
    ...
    # 设置文件路径
    CSV_FILE_PATH_1 = '../block_categories/' + filename_label + '_cnts_block_categories.csv'
    # 定义存储数据结构
    cnts_data = []
    road_area = []
    ...
    # 设置文件路径
    CSV_FILE_PATH_2 = '../block_categories/' + filename_label +'_info_block_categories.csv'
    # 定义存储数据结构
    info_data = []
    # 数据读取
